...
@Setter
@Entity
@Table(name = "drink_sales_weekly")
public class DrinkSalesWeekly extends BaseEntity {
    ...
    private BigDecimal averageDailyQuantity;

    @Column(nullable = false, precision = 14, scale = 4)
    private BigDecimal averageDailyVolumeMl;
}
