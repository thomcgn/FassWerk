-- Tabelle für tägliche Verkaufsaggregate
...
-- Tabelle für wöchentliche Verkaugsaggregate
...
-- Tabelle für berechnete Nachbestellempfehlungen
...
-- Metadaten für Konsumption (Lead-Time, Safety-Stock-Faktor)
